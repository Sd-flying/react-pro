...
const Richs = Loadable({loader: () => import('../pages/ui/rich'), loading : DelayLoading})
...
const FormRegister = Loadable({loader: () => import('../pages/form/register'), loading : DelayLoading})
...
const LoginPage = Loadable({loader: () => import('../pages/login'), loading : DelayLoading})
